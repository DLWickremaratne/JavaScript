...
const mainNav = document.createElement("nav"); //create nav element
mainNav.classList.add("main-navigation"); //grabbed that new main nav use class lists and add a new class to it called main navigation
const navList = document.createElement("ul"); //another constant
navList.innerHTML = navContent; //grabbed nav list and set the inner HTML through nav content
mainNav.append(navList); //append nav list to mainnv

document.querySelector(".siteheader").append(mainNav); //find site header and append main nav to siteheader

//byusing append method and nav to bottom
